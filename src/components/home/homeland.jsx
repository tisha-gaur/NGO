...
const Homeland = () => {
  return (
    ...
    <div className=" px-24 position-center" >
      <h1 className=" text-gray-700 text-4xl leading-2.5">
        <span className="font-semibold">BECOME A PART OF A <span className="text-blue-700">COMMUNITY</span> of</span> <br />
        <span className=" font-semibold text-gray-700"><spam className="font-SemiBold text-blue-700">MILLIONS</spam>{" "}
    ...
    <div className=" w-1/2 flex justify-center items-center">
      <img className="rounded-full w-2/3 pt-14 h-full" src={children} alt="children" />
    </div>
  </div>
  )
}
